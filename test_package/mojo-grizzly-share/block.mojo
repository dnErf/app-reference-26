...
var blockchain = List[Block]()

fn create_genesis_block() -> Block:
    return Block(0, "Genesis Block", "0")

fn add_block_to_chain(data: String):
    var previous_hash = blockchain[-1].hash if len(blockchain) > 0 else "0"
    var new_block = Block(Int64(len(blockchain)), data, previous_hash)
